...
if(player1){
    ...
    button_selection.style.color = "black";
}
else{
    button_selection.innerText = "O";
    button_selection.style.color = "red";
}
button_selection.disabled = true;
button_selection.style.cursor = "default";
matrix[0][0] = player1? "X": "O"; ////operador ternario coloca ya en posicion referente a true o false
...
function boton01 (player1,matrix, contador_selecciones){
    ...
    button_selection.disabled = true;
    button_selection.style.cursor = "default";
    matrix[0][1] = player1? "X": "O"; ////operador ternario coloca ya en posicion referente a true o false
    ganador= validar (player1, matrix, contador_selecciones);
    if(ganador===0){
        player1 = !player1;
        turno(player1);
    ...
    function boton02 (player1,matrix, contador_selecciones){
        ...
        button_selection.disabled = true;
        button_selection.style.cursor = "default";
        matrix[0][2] = player1? "X": "O"; ////operador ternario coloca ya en posicion referente a true o false
        ganador= validar (player1, matrix, contador_selecciones);
        if(ganador===0){
            player1 = !player1;
            turno(player1);
        ...
        function boton10 (player1,matrix, contador_selecciones){
            ...
            button_selection.disabled = true;
            button_selection.style.cursor = "default";
            matrix[1][0] = player1? "X": "O"; ////operador ternario coloca ya en posicion referente a true o false
            ganador= validar (player1, matrix, contador_selecciones);
            if(ganador===0){
                player1 = !player1;
                turno(player1);
            ...
            function boton11 (player1,matrix, contador_selecciones){
                ...
                button_selection.disabled = true;
                button_selection.style.cursor = "default";
                matrix[1][1] = player1? "X": "O"; ////operador ternario coloca ya en posicion referente a true o false
                ganador= validar (player1, matrix, contador_selecciones);
                if(ganador===0){
                    player1 = !player1;
                    turno(player1);
                ...
                function boton12 (player1,matrix, contador_selecciones){
                    ...
                    button_selection.disabled = true;
                    button_selection.style.cursor = "default";
                    matrix[1][2] = player1? "X": "O"; ////operador ternario coloca ya en posicion referente a true o false
                    ganador= validar (player1, matrix, contador_selecciones);
                    if(ganador===0){
                        player1 = !player1;
                        turno(player1);
                    ...
                    function boton20 (player1,matrix, contador_selecciones){
                        ...
                        button_selection.disabled = true;
                        button_selection.style.cursor = "default";
                        matrix[2][0] = player1? "X": "O"; ////operador ternario coloca ya en posicion referente a true o false
                        ganador= validar (player1, matrix, contador_selecciones);
                        if(ganador===0){
                            player1 = !player1;
                            turno(player1);
                        ...
                        function boton21 (player1,matrix, contador_selecciones){
                            ...
                            button_selection.disabled = true;
                            button_selection.style.cursor = "default";
                            matrix[2][1] = player1? "X": "O"; ////operador ternario coloca ya en posicion referente a true o false
                            ganador= validar (player1, matrix, contador_selecciones);
                            if(ganador===0){
                                player1 = !player1;
                                turno(player1);
                            ...
                            function boton22 (player1,matrix, contador_selecciones){
                                ...
                                button_selection.disabled = true;
                                button_selection.style.cursor = "default";
                                matrix[2][2] = player1? "X": "O"; ////operador ternario coloca ya en posicion referente a true o false
                                ganador= validar (player1, matrix, contador_selecciones);
                                if(ganador===0){
                                    player1 = !player1;
                                    turno(player1);
